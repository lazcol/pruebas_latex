...
$$\oint_{C} \frac{z-2}{z^2-\left( \frac{3T-1}{S}\right)z+2}\,\mathrm{d}z$$
...
\question Encontrar el desarrollo en serie de Laurent centrado en $z=-\left( \frac{2S+1}{3T} \right)$ de la función
